...
def CHECK():
    ...
    print('>>>>>>>开始获取版本信息...')
    baseurl = 'https://github.com/xulifu0415/Self-use-Qinglong-script/tree/main'
    TOOLS_NAME = 'CHERWIN_TOOLS.py'
    server_script_url = f'https://github.com/xulifu0415/Self-use-Qinglong-script/tree/main{TOOLS_NAME}'
    try:
